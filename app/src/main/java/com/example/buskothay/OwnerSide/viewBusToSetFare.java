...
public class viewBusToSetFare extends AppCompatActivity {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if(busList.size()==0)
                        Toast.makeText(viewBusToSetFare.this, "No Bus Found", Toast.LENGTH_LONG).show();
                    progressDialog.dismiss();
                    BusUpdatedAdapter adapter = new BusUpdatedAdapter(viewBusToSetFare.this, busList);
        ...
        listViewBuses.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(bus.getDriver()!=null && bus.getDriverId()!=null)
                    showDetailInfo(bus.getRoute_Id(),bus.getOwner().getID(),bus.getTravelsName(), bus.getBusType(), bus.getFrom(), bus.getModelName(), bus.getModelYear(), bus.getOwner().getID(), bus.getRegistrationNumber(), bus.getRegistrationYear(), bus.getSittingCapacity(), bus.getTo(), bus.getBus_Stoppage(), bus.getDriver().getPhoneNumber(), bus.getDriver().getPassword());
                else
                    showDetailInfo(bus.getRoute_Id(),bus.getOwner().getID(),bus.getTravelsName(), bus.getBusType(), bus.getFrom(), bus.getModelName(), bus.getModelYear(), bus.getOwner().getID(), bus.getRegistrationNumber(), bus.getRegistrationYear(), bus.getSittingCapacity(), bus.getTo(), bus.getBus_Stoppage(), "Null Driver", "Null Password");
            }
        });
    ...
    private void showDetailInfo(String routeId,String owner_Id,String BusName, String busType, String fromLocation, String modelName, String modelYear, String ownerId, String Reg_no, String Reg_Year, String Sit_cap, String to_Location, ArrayList<String> stoppages, String DriverMobile, String driverPassword) {


        Intent intent = new Intent(this, activitySetFare.class);
        System.out.println("HAS!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"+routeId);
        intent.putExtra("message_Routeid",routeId);
        intent.putExtra("message_ownerId",owner_Id);
    ...
    private void deleteBus(String busId, String ownerId, String driverID) {
        ...
        if (currentUser.equalsIgnoreCase(ownerId)) {
