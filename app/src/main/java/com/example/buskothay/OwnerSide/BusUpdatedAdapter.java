...
//Using Bus Details Object
public class BusUpdatedAdapter extends ArrayAdapter<BusDetails> {
    private Activity context;
    private List<BusDetails> bus_details_List;

    public BusUpdatedAdapter(Activity context, List<BusDetails> bus_details_List) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        BusDetails bus = bus_details_List.get(position);
